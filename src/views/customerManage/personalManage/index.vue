  ...
  <div class="app-container">
      ...
      <el-card class="box-card" shadow="hover" style="margin: 15px 0 5px;">
        ...
        <el-row class="tag-row">
          ...
          <el-col :span="6">
            ...
            <el-button class="addBtn" type="primary" @click="dialogTableVisible = true">新建个人客户</el-button>
          </el-col>
        </el-row>
      </el-card>
    </div>
    ...
    <div class="people-list">
      ...
      >
        ...
        <el-table-column label="客户姓名" min-width="90px" align="center">
          <template slot-scope="scope">
...
import { getPersonalCustomerData, delCustomer, getSubTag, getSalesPerson, getNetCity, getCustomerTag, addPersonCustomer } from '@/api/dingpc/customerManage'
