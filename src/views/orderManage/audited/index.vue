<template>
  <div class="app-container">
    ...
    <div class="all-data">
      <el-row>
        <el-col :span="8" class="data-li li1">已审核单数：{{allData.orderNum}}</el-col>
        <el-col :span="8" class="data-li li2">已审核销售额：{{allData.orderSalesNum}}</el-col>
      </el-row>
    </div>
    ...
    <div class="btn" style="margin: 20px 0">
      <el-button-group>
        <el-button type="primary">已通过列表</el-button>
        <el-button type="info">已拒绝列表</el-button>
      </el-button-group>
    </div>
